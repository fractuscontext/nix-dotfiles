    ...
    zsh = {
      ...
      initContent = ''
        ...
        ignore_patterns=(
          ...
          "echo [^|><]*" "cat [^|><]*" "less *"     # Echo/Cat (ignore unless piping/redirecting)
        ...
        # Prevent typos (Command Not Found / Err 127) from being saved.
        zshaddhistory() { 
